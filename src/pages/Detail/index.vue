      ...
      <div class="mainCon">
        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            ...
            <div class="cartWrap">
              <div class="controls">
                <input autocomplete="off" class="itxt" v-model.number="skuNum" @change="changeSkuNum($event)">
                <a href="javascript:" class="plus" @click="skuNum++">+</a>
                <a href="javascript:" class="mins" @click="skuNum>1?skuNum-- : skuNum=1">-</a>
              </div>
              <div class="add">
                <a @click="postShopCart">加入购物车</a>
              </div>
            </div>
          </div>
        </div>
  ...
  export default {
    ...
    methods: {
      ...
      changeActive(spuSaleAttrValue,spuSaleAttrValueList) {
        // spuSaleAttrValue为点击本身，spuSaleAttrValueList为点击本身的父级
      ...
      postShopCart() {
        try {
          this.$store.dispatch('addShopCart',{skuId:this.$route.params.id,skuNum:this.skuNum})
          this.$router.push({
            name:'AddCartSuccess',
